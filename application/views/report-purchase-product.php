<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form action="printreportpurchaseproduct" class="form-horizontal" method="post">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 style="color: #fff;"><span class="fa fa-list"></span> Reports -  Purchase Product</h3>
                        </div>
                        <div class="panel-body form-group-sepaquantityd">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <a href="printreportpurchaseproduct1" class="btn btn-primary btn-rounded">Download Report</a>
...
<script>
    ...
    document.querySelector("button").addEventListener("click", function () {
        ...
        export_table_to_csv(html, document.title+".csv");
    });
</script>