<br><br><br><br>
<form id="addform" name="addform" action="<?php echo base_url();?>welcome/editpurchaseproduct1" class="form-horizontal" method="post">
    <br><br><br><br>
    <div class="col-xs-12">
        <div class="col-md-12" >
            <div id="field">
                <div id="field0">
                    ...
                    <input type="hidden" name="purchase_id" class="form-control" value="<?php echo $purchase_id;?>">
                    <input type="hidden" name="purchase_product_id" class="form-control" value="<?php echo $purchase_product_id;?>">
                    <div class="form-group col-md-12">
