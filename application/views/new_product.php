...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form   action="new_product1" class="form-horizontal" method="post">
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input name="cgst" id="email" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input name="sgst" id="email" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input name="igst" id="email" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
