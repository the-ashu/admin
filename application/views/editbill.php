...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form id="addform" name="addform" action="<?php echo base_url();?>welcome/editbill1/<?php echo $f->bill_id;?>/<?php echo $g->bill_detail_id;?>" class="form-horizontal" method="post">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 style="color: #fff;"><span class="fa fa-file-o"></span> Edit Bill</h3>
                        </div>
