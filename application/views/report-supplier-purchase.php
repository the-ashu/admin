<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form action="printsupplierpurchase" class="form-horizontal" method="post">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 style="color: #fff;"><span class="fa fa-list"></span> Reports - supplier purhase</h3>
                        </div>
                        <div class="panel-body form-group-sepaquantityd">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <a href="printsupplierpurchase1" class="btn btn-primary btn-rounded">Download Report</a>
