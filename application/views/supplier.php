                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <h4 class="text-dark header-title m-t-0">Supplier</h4>
    ...
    <div id="add" class="modal" style="display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form role="form" id="addform" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return forminput('addform')" action="functions/supplier.php?do=add">
...
<script type="text/javascript" language="javascript" >
    ...
    function show()
    {
        var dataTable = $('#data-grid').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                url :"functions/supplier.php?do=show", // json datasource
    ...
    function edit(id)
    {
        ...
        $.ajax({
            url:'functions/supplier.php?do=editform',
            type:'post',
            data:'id='+id,
    ...
    function delete_data(id)
    {
        ...
        {
            $.ajax({
                url:'functions/supplier.php?do=delete',
                type:'post',
                data:'id='+id,
                success:function(msg)
                {
