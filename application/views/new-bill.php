...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form id="addform" name="addform" action="functions/bill.php?do=add" class="form-horizontal" method="post">
                        ...
                        <div class="panel-body form-group-separated">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <select name="client_id" id="client" class="form-control" required onchange="client_detail(this.value)">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" value="05-08-2018" placeholder="mm/dd/yyyy" required id="datepicker-autoclose" type="text" name="date">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="invoice_date"  value="05-08-2018" class="form-control inline-date">
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
