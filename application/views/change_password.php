<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            ...
            <form id="upform" action="change_pass" enctype="multipart/form-data" method="post" class="form-horizontal">
                ...
                <div class="col-md-9 col-sm-8 col-xs-7">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <center> <?php if($valid==false){ echo "Invalid Inputs";}?></center>
                            <div class="form-group">
                                <div class="col-md-12 col-xs-5">
                                    <button type="submit" class="btn btn-primary btn-rounded pull-right">Change</button>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post" action="functions/profile.php?do=changephoto">
                        ...
                        <div class="modal-body text-center">
                            <div class="clearfix">
                                <input name="image" type="file" required data-show-upload="false" accept="image/*" class="file-loading fileinput">
                            </div>
                        </div>
