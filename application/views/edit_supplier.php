...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form   action="<?php echo base_url();?>welcome/update_supplier?>" class="form-horizontal" method="post">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 style="color: #fff;"><span class="fa fa-file-o"></span>Edit Supplier</h3>
                        </div>
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input name="address" id="email" class="form-control" type="text" value="<?php echo $h['address'];?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-5">
                                        <input name="gst_no" id="email" class="form-control" type="text" value="<?php echo $h['gst_no'];?>">
                                    </div>
                                </div>
                            </div>
