            ...
            <?php foreach($h->result() as $row){?>
                <tr>
                    ...
                    <td><?php if($row->status==1)
                        {?> <a href="clientstatus/<?php echo $row->client_id;?>/<?php echo $row->status;?>" class="pull-right btn btn-primary btn-sm waves-effect waves-light"> Enable</a><?php }else {?> <a href="clientstatus/<?php echo $row->client_id;?>/<?php echo $row->status;?>" class="pull-right btn btn-danger btn-sm waves-effect waves-light"> Disable</a><?php }?></td>
                    <td><div class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Action
                                <span class="caret"></span></button>
                            <ul class="dropdown-menu">
                                <li><a href="edit_client/<?php echo $row->client_id;?>">Edit</a></li>
                                <li><a href="delete_client/<?php echo $row->client_id?>">Delete</a></li>
                            </ul>
                        </div></td>
                </tr>
            <?php }?>
